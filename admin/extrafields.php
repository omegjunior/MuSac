...
$elementtype = 'musac'; // extrafields table name without '_extrafields'
...
print_header('ExtraFields', array('admin', 'musac@musac'));
...
$form = new Form($db);
$textobject = $langs->trans('MuSac'); // object name/text, e.: 'MyObject'
